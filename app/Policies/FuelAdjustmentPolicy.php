...
class FuelAdjustmentPolicy
{
    ...
    public function view(User $user, FuelAdjustment $model): bool { return $this->allowed($user); }
    public function create(User $user): bool { return $this->allowed($user); }
    public function update(User $user, FuelAdjustment $model): bool { return $this->allowed($user); }
    public function delete(User $user, FuelAdjustment $model): bool { return $this->allowed($user); }
}
