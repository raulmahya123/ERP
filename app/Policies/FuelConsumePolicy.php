...
class FuelConsumePolicy
{
    ...
    public function view(User $user, FuelConsume $model): bool { return $this->allowed($user); }
    public function create(User $user): bool { return $this->allowed($user); }
    public function update(User $user, FuelConsume $model): bool { return $this->allowed($user); }
    public function delete(User $user, FuelConsume $model): bool { return $this->allowed($user); }
}
