...
class FuelReceivePolicy
{
    ...
    public function view(User $user, FuelReceive $model): bool { return $this->allowed($user); }
    public function create(User $user): bool { return $this->allowed($user); }
    public function update(User $user, FuelReceive $model): bool { return $this->allowed($user); }
    public function delete(User $user, FuelReceive $model): bool { return $this->allowed($user); }
}
