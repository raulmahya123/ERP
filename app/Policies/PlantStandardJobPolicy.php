...
class PlantStandardJobPolicy
{
    ...
    public function view(User $user, PlantStandardJob $model): bool { return $this->allowed($user); }
    public function create(User $user): bool { return $this->allowed($user); }
    public function update(User $user, PlantStandardJob $model): bool { return $this->allowed($user); }
    public function delete(User $user, PlantStandardJob $model): bool { return $this->allowed($user); }
}
