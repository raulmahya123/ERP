...
class FuelTankPolicy
{
    ...
    public function view(User $user, FuelTank $model): bool { return $this->allowed($user); }
    public function create(User $user): bool { return $this->allowed($user); }
    public function update(User $user, FuelTank $model): bool { return $this->allowed($user); }
    public function delete(User $user, FuelTank $model): bool { return $this->allowed($user); }
}
