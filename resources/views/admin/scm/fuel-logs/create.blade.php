@extends('layouts.app')
@section('title','SCM — Tambah Fuel Log')
    ...
    <div class="relative px-6 sm:px-10 py-6 text-white">
      <div class="flex items-start justify-between gap-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight">SCM — Tambah Fuel Log</h1>
            <p class="text-white/90 text-sm mt-1">Catat pengisian BBM unit.</p>
          </div>
        </div>
