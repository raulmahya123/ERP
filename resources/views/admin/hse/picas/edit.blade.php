<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><title>Edit PICA</title>
@vite(['resources/css/app.css','resources/js/app.js'])</head>
<body class="bg-slate-50">
<div class="max-w-3xl mx-auto p-6">
  <h1 class="text-2xl font-bold text-slate-800 mb-4">Edit PICA</h1>
  <form method="POST" action="{{ route('admin.hse.picas.update', $pica) }}" class="space-y-3">
    @csrf @method('PUT')
