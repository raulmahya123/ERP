...
<div class="rounded-3xl shadow ring-1 ring-slate-200 overflow-hidden">
  ...
  <div class="p-6 sm:p-10">
    <form method="POST" action="{{ route('asset-mgmt.asset-delivery-instructions.update', $assetDeliveryInstruction) }}" class="max-w-2xl space-y-4">
      @csrf @method('PUT')
      ...
      <div class="flex gap-3"><button class="px-4 py-2 rounded bg-indigo-600 text-white font-semibold">Update</button><a href="{{ route('asset-mgmt.asset-delivery-instructions.index', ['site' => $siteId]) }}" class="px-4 py-2 rounded border border-slate-300">Batal</a></div>
    </form>
  </div>
</div>
@endsection
