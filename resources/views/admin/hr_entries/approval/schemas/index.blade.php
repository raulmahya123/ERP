{{-- resources/views/admin/hr_entries/approval/schemas/index.blade.php --}}
@extends('layouts.app')
...
<div class="max-w-5xl mx-auto space-y-4">
  <div class="flex items-center justify-between">
    <h1 class="text-xl font-bold text-slate-800">Approval Schemas</h1>
    ...
    <ul class="grid grid-cols-1 md:grid-cols-2 gap-3">
      @foreach($types as $k=>$label)
        <li class="p-3 rounded-lg border border-slate-200">
          ...
          <div class="mt-2">
            <a href="{{ route('admin.hr-entries.approval-schemas.show', $k) }}" class="px-3 py-2 rounded-lg text-sm font-semibold bg-teal-600 text-white hover:bg-teal-700">Configure</a>
          </div>
        </li>
      @endforeach
    </ul>
