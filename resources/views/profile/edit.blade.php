...
<div class="relative overflow-hidden rounded-3xl shadow-xl ring-1 ring-emerald-900/10 mb-8">
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16 text-white">
      ...
      <div class="flex items-center gap-4">
        <div class="grid place-items-center h-12 w-12 rounded-2xl bg-white/10 text-white font-bold shadow ring-1 ring-white/20 backdrop-blur">
